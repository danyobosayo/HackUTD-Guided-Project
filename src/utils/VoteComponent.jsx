...
function VoteComponent() {
  ...
  const handleVote = async (activity) => {
    ...
    setVotes((prevVotes) => ({
      ...prevVotes,
      [userVote]:
        userVote && userVote !== activity
          ? prevVotes[userVote] - 1
          : prevVotes[userVote],
    ...
    <div className="">
      ...
      <div className="flex gap-2 mb-4">
        <button
          ...
          disabled={!user}
          className={`py-2 px-4 ${userVote === "activity1" ? "" : ""} ${
            !user ? "" : ""
          }`}
        >
          Activity 1
        ...
        <button
          ...
          disabled={!user}
          className={`py-2 px-4 ${userVote === "activity2" ? "" : ""} ${
            !user ? "" : ""
          }`}
        >
          Activity 2
        ...
        <button
          ...
          disabled={!user}
          className={`py-2 px-4 ${userVote === "activity3" ? "" : ""} ${
            !user ? "" : ""
          }`}
        >
          Activity 3
